...
class Ui_Menu(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.pushButton_2.clicked.connect(lambda: self.openRanking())
    ...
    def retranslateUi(self):
        ...
        self.pushButton.setText(_translate("Dialog", "休闲模式"))
    ...
    def openRanking(self):
        os.system('python ../ranking/ranking.py')
...
if __name__ == '__main__':
    ...
    pygame.mixer.init()
    # 加载音乐文件
    track = pygame.mixer.music.load(r'../music/BGM.mp3')
    # 开始播放音乐流
